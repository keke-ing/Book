...
### 6. 关闭SELinux
>getenforce 如果为Permissive or Disabled,跳过此步骤<br>
...
### 5. 安装数据库
   ...
   >sudo apt-get install mariadb-server  
    ...
    确认my.cnf(一般存在/etc/mysql/my.cnf下或者/etc/my.cnf)  
...
### 6. 安装MySQL JDBC Driver for MariaDB
...
### 8. Cloudera Manager数据库设置
   >格式为sudo /opt/cloudera/cm/schema/scm_prepare_database.sh [options] \<databaseType> \<databaseName> \<databaseUser> \<password>  
